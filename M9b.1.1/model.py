class Grundrechnung:
    ...
    def berechnen(self, z1: int, z2: int, op: str) -> str:
        self.z1 = z1
        self.z2 = z2
        self.op = op[0]
        ...
        if self.op == "+": self.add()
            ...
            self.error = f"Fehler: unbekannter Operation {self.op}"
...
if __name__ == '__main__':
    ...
    for c in range(len(calc)):
        ...
        if e is None:
            print(f"{g.z1} {g.op} {g.z2} = {g.erg}")
        else:
            print(f"Die Berechnung {g.z1} {g.op} {g.z2} war leider nicht möglich\n{e}")
